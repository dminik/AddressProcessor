...
namespace AddressProcessing.CSV
{
	...
	//- If we need to have more flexibility in CSVReaderWriter with appending new info to file or have different separators or 
	//  file ecoding we could make in addition in new constructors and a method Open() adding optional parameters.
